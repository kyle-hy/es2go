...
// MatchBooksByAuthorClassNamePageCountPrice 对author、class、书名、page_count、价格进行检索(等于)查询books的详细数据列表和总数量
// author string author
// class string class
// name string 书名
// pageCount int64 page_count
// price float64 价格
func MatchBooksByAuthorClassNamePageCountPrice(es *elasticsearch.Client, author string, class string, name string, pageCount int64, price float64) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
		eq.Match("name", name),
	}
...
// MatchBooksByAuthorClassNamePageCountReleaseDate 对author、class、书名、page_count、release_date进行检索(等于)查询books的详细数据列表和总数量
// author string author
// class string class
// name string 书名
// pageCount int64 page_count
// releaseDate time.Time release_date
func MatchBooksByAuthorClassNamePageCountReleaseDate(es *elasticsearch.Client, author string, class string, name string, pageCount int64, releaseDate time.Time) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
		eq.Match("name", name),
	}
...
// MatchBooksByAuthorClassNamePageCountSeq 对author、class、书名、page_count、seq进行检索(等于)查询books的详细数据列表和总数量
// author string author
// class string class
// name string 书名
// pageCount int64 page_count
// seq string seq
func MatchBooksByAuthorClassNamePageCountSeq(es *elasticsearch.Client, author string, class string, name string, pageCount int64, seq string) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
		eq.Match("name", name),
	}
...
// MatchBooksByAuthorClassNamePriceReleaseDate 对author、class、书名、价格、release_date进行检索(等于)查询books的详细数据列表和总数量
// author string author
// class string class
// name string 书名
// price float64 价格
// releaseDate time.Time release_date
func MatchBooksByAuthorClassNamePriceReleaseDate(es *elasticsearch.Client, author string, class string, name string, price float64, releaseDate time.Time) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
		eq.Match("name", name),
	}
...
// MatchBooksByAuthorClassNamePriceSeq 对author、class、书名、价格、seq进行检索(等于)查询books的详细数据列表和总数量
// author string author
// class string class
// name string 书名
// price float64 价格
// seq string seq
func MatchBooksByAuthorClassNamePriceSeq(es *elasticsearch.Client, author string, class string, name string, price float64, seq string) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
		eq.Match("name", name),
	}
...
// MatchBooksByAuthorClassNameReleaseDateSeq 对author、class、书名、release_date、seq进行检索(等于)查询books的详细数据列表和总数量
// author string author
// class string class
// name string 书名
// releaseDate time.Time release_date
// seq string seq
func MatchBooksByAuthorClassNameReleaseDateSeq(es *elasticsearch.Client, author string, class string, name string, releaseDate time.Time, seq string) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
		eq.Match("name", name),
	}
...
// MatchBooksByAuthorClassPageCountPriceReleaseDate 对author、class、page_count、价格、release_date进行检索(等于)查询books的详细数据列表和总数量
// author string author
// class string class
// pageCount int64 page_count
// price float64 价格
// releaseDate time.Time release_date
func MatchBooksByAuthorClassPageCountPriceReleaseDate(es *elasticsearch.Client, author string, class string, pageCount int64, price float64, releaseDate time.Time) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
	}
	terms := []eq.Map{
...
// MatchBooksByAuthorClassPageCountPriceSeq 对author、class、page_count、价格、seq进行检索(等于)查询books的详细数据列表和总数量
// author string author
// class string class
// pageCount int64 page_count
// price float64 价格
// seq string seq
func MatchBooksByAuthorClassPageCountPriceSeq(es *elasticsearch.Client, author string, class string, pageCount int64, price float64, seq string) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
	}
	terms := []eq.Map{
...
// MatchBooksByAuthorClassPageCountReleaseDateSeq 对author、class、page_count、release_date、seq进行检索(等于)查询books的详细数据列表和总数量
// author string author
// class string class
// pageCount int64 page_count
// releaseDate time.Time release_date
// seq string seq
func MatchBooksByAuthorClassPageCountReleaseDateSeq(es *elasticsearch.Client, author string, class string, pageCount int64, releaseDate time.Time, seq string) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
	}
	terms := []eq.Map{
...
// MatchBooksByAuthorClassPriceReleaseDateSeq 对author、class、价格、release_date、seq进行检索(等于)查询books的详细数据列表和总数量
// author string author
// class string class
// price float64 价格
// releaseDate time.Time release_date
// seq string seq
func MatchBooksByAuthorClassPriceReleaseDateSeq(es *elasticsearch.Client, author string, class string, price float64, releaseDate time.Time, seq string) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
	}
	terms := []eq.Map{
...
// MatchBooksByAuthorNamePageCountPriceReleaseDate 对author、书名、page_count、价格、release_date进行检索(等于)查询books的详细数据列表和总数量
// author string author
// name string 书名
// pageCount int64 page_count
// price float64 价格
// releaseDate time.Time release_date
func MatchBooksByAuthorNamePageCountPriceReleaseDate(es *elasticsearch.Client, author string, name string, pageCount int64, price float64, releaseDate time.Time) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
		eq.Match("name", name),
	}
...
// MatchBooksByAuthorNamePageCountPriceSeq 对author、书名、page_count、价格、seq进行检索(等于)查询books的详细数据列表和总数量
// author string author
// name string 书名
// pageCount int64 page_count
// price float64 价格
// seq string seq
func MatchBooksByAuthorNamePageCountPriceSeq(es *elasticsearch.Client, author string, name string, pageCount int64, price float64, seq string) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
		eq.Match("name", name),
	}
...
// MatchBooksByAuthorNamePageCountReleaseDateSeq 对author、书名、page_count、release_date、seq进行检索(等于)查询books的详细数据列表和总数量
// author string author
// name string 书名
// pageCount int64 page_count
// releaseDate time.Time release_date
// seq string seq
func MatchBooksByAuthorNamePageCountReleaseDateSeq(es *elasticsearch.Client, author string, name string, pageCount int64, releaseDate time.Time, seq string) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
		eq.Match("name", name),
	}
...
// MatchBooksByAuthorNamePriceReleaseDateSeq 对author、书名、价格、release_date、seq进行检索(等于)查询books的详细数据列表和总数量
// author string author
// name string 书名
// price float64 价格
// releaseDate time.Time release_date
// seq string seq
func MatchBooksByAuthorNamePriceReleaseDateSeq(es *elasticsearch.Client, author string, name string, price float64, releaseDate time.Time, seq string) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
		eq.Match("name", name),
	}
...
// MatchBooksByAuthorPageCountPriceReleaseDateSeq 对author、page_count、价格、release_date、seq进行检索(等于)查询books的详细数据列表和总数量
// author string author
// pageCount int64 page_count
// price float64 价格
// releaseDate time.Time release_date
// seq string seq
func MatchBooksByAuthorPageCountPriceReleaseDateSeq(es *elasticsearch.Client, author string, pageCount int64, price float64, releaseDate time.Time, seq string) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("author", author),
	}
	terms := []eq.Map{
...
// MatchBooksByClassNamePageCountPriceReleaseDate 对class、书名、page_count、价格、release_date进行检索(等于)查询books的详细数据列表和总数量
// class string class
// name string 书名
// pageCount int64 page_count
// price float64 价格
// releaseDate time.Time release_date
func MatchBooksByClassNamePageCountPriceReleaseDate(es *elasticsearch.Client, class string, name string, pageCount int64, price float64, releaseDate time.Time) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("name", name),
	}
	terms := []eq.Map{
...
// MatchBooksByClassNamePageCountPriceSeq 对class、书名、page_count、价格、seq进行检索(等于)查询books的详细数据列表和总数量
// class string class
// name string 书名
// pageCount int64 page_count
// price float64 价格
// seq string seq
func MatchBooksByClassNamePageCountPriceSeq(es *elasticsearch.Client, class string, name string, pageCount int64, price float64, seq string) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("name", name),
	}
	terms := []eq.Map{
...
// MatchBooksByClassNamePageCountReleaseDateSeq 对class、书名、page_count、release_date、seq进行检索(等于)查询books的详细数据列表和总数量
// class string class
// name string 书名
// pageCount int64 page_count
// releaseDate time.Time release_date
// seq string seq
func MatchBooksByClassNamePageCountReleaseDateSeq(es *elasticsearch.Client, class string, name string, pageCount int64, releaseDate time.Time, seq string) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("name", name),
	}
	terms := []eq.Map{
...
// MatchBooksByClassNamePriceReleaseDateSeq 对class、书名、价格、release_date、seq进行检索(等于)查询books的详细数据列表和总数量
// class string class
// name string 书名
// price float64 价格
// releaseDate time.Time release_date
// seq string seq
func MatchBooksByClassNamePriceReleaseDateSeq(es *elasticsearch.Client, class string, name string, price float64, releaseDate time.Time, seq string) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("name", name),
	}
	terms := []eq.Map{
...
// MatchBooksByClassPageCountPriceReleaseDateSeq 对class、page_count、价格、release_date、seq进行检索(等于)查询books的详细数据列表和总数量
// class string class
// pageCount int64 page_count
// price float64 价格
// releaseDate time.Time release_date
// seq string seq
func MatchBooksByClassPageCountPriceReleaseDateSeq(es *elasticsearch.Client, class string, pageCount int64, price float64, releaseDate time.Time, seq string) (*eq.Data, *eq.Query, error) {
	terms := []eq.Map{
		eq.Term("class", class),
		eq.Term("page_count", pageCount),
		eq.Term("price", price),
...
// MatchBooksByNamePageCountPriceReleaseDateSeq 对书名、page_count、价格、release_date、seq进行检索(等于)查询books的详细数据列表和总数量
// name string 书名
// pageCount int64 page_count
// price float64 价格
// releaseDate time.Time release_date
// seq string seq
func MatchBooksByNamePageCountPriceReleaseDateSeq(es *elasticsearch.Client, name string, pageCount int64, price float64, releaseDate time.Time, seq string) (*eq.Data, *eq.Query, error) {
	matches := []eq.Map{
		eq.Match("name", name),
	}
	terms := []eq.Map{
